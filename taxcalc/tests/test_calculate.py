...
def test_Calculator_mtr_when_PT_rates_differ():
    ...
    rec1 = Records(pd.read_csv(StringIO(funit)),
                   adjust_factors=pd.read_csv(StringIO(fadj)))
...
def test_Calculator_create_difference_table(puf_1991, weights_1991,
    ...
    policy1 = Policy()
    puf1 = Records(data=puf_1991, weights=weights_1991,
    ...
    puf2 = Records(data=puf_1991, weights=weights_1991,
                   adjust_factors=adjust_1991, start_year=2009)
...
def test_ID_HC_vs_BS(puf_1991, weights_1991, adjust_1991):
    """
    ...
    hc_records = Records(data=puf_1991, weights=weights_1991,
                         adjust_factors=adjust_1991, start_year=2009)
    ...
    bs_records = Records(data=puf_1991, weights=weights_1991,
                         adjust_factors=adjust_1991, start_year=2009)
