...
def test_make_Calculator_with_reform_after_start_year():
    ...
    assert_allclose(calc.policy._STD_Aged, exp_STD_Aged,
                    atol=0.5, rtol=0.0)
    assert_allclose(calc.policy._II_em, exp_II_em,
                    atol=0.5, rtol=0.0)
...
def test_make_Calculator_user_mods_with_cpi_flags(policyfile):
    ...
    assert_allclose(act_almdep, exp_almdep, atol=0.5, rtol=0.0)
    ...
    assert_allclose(act_almsep, exp_almsep, atol=0.5, rtol=0.0)
