...
def test_ID_HC_vs_BS(puf_subsample):
    ...
    hc_calc.calc_all()
    hc_taxes = hc_calc.dataframe(['payrolltax', 'iitax'])
    del hc_calc
    ...
    bs_calc.calc_all()
    bs_taxes = bs_calc.dataframe(['payrolltax', 'iitax'])
    del bs_calc
