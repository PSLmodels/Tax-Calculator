...
"""
# CODING-STYLE CHECKS:
# pycodestyle tc_dump_to_taxsim_out.py
# pylint --disable=locally-disabled tc_dump_to_taxsim_out.py
...
def main():
    ...
    usage_str = 'python tc_dump_to_taxsim_out.py INPUT OUTPUT [--help]'
    parser = argparse.ArgumentParser(
        prog='',
        usage=usage_str,
        description=('Translates tc --dump output file into an '
    ...
    parser.add_argument('INPUT', nargs='?', default='',
                        help=('INPUT is name of file that does contain '
                              'tc --dump output.'))
    parser.add_argument('OUTPUT', nargs='?', default='',
                        help=('OUTPUT is name of file that will contain '
                              'TAXSIM 28-variable output.'))
    args = parser.parse_args()
    # check INPUT filename
    if args.INPUT == '':
        sys.stderr.write('ERROR: must specify INPUT file name\n')
        sys.stderr.write('USAGE: python tc_dump_to_taxsim.out.py --help\n')
        return 1
