...
`tclsh make_in.tcl 2014 a > a2014.in`
...
`tclsh make_in.tcl 2014 a 1 > a2014-1.in`
...
`tclsh make_in.tcl 2013 b > b2013.in`
...
`tclsh make_in.tcl 2013 c > c2013.in`
...
make_in.tcl program.  There are c samples (see make_in.tcl
...
regarding (a) the non-calculation of the Schedule R credit and (b) the
approximation of Form 2441 qualified persons for whom child-care expenses
are incurred.

`python ../../simtax.py --noschR --taxsim2441 c2013.in`
