...
# USAGE: tclsh taxdiffs.tcl [--ovar4] first-output-file second-output-file
...
if { $argc < 2 || $argc > 3 } {
    set args "\[--ovar4\] first-output-file second-output-file"
...
if { $argc == 2 } {
    ...
    if { [string compare $option "--ovar4"] == 0 } {
        ...
        puts stderr "ERROR: option '$option' is not '--ovar4'"
        exit 1
    }
}
