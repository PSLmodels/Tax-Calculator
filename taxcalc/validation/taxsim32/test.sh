#!/bin/bash
# Executes one TAXSIM-32 validation test as follows:
...
#     output file generated by TAXSIM-32 using the INPUT
#
...
# (2) generate TAXSIM-32-formatted output using Tax-Calculator tc CLI
...
# ... unzip TAXSIM-32 OUTPUT for specified INPUT
unzip -oq output-taxsim.zip $LYY.in.out-taxsim
# ... compare Tax-Calculator OUTPUT and TAXSIM-32 OUTPUT files
