...
class GrowModel(ParametersBase):
    ...
    Modify calc2 records to account for behavioral responses that arise
      ...
      executed before calling the GrowModel.response(calc1, calc2) method.
    ...
    if calc2.behavior('BE_sub') == 0.0 and calc2.behavior('BE_inc') == 0.0:
        ...
        wage_mtr1, wage_mtr2 = GrowModel._mtr12(calc1, calc2,
                                               mtr_of='e00200p',
                                               tax_type='combined')
    ...
    if calc2.behavior('BE_cg') == 0.0:
        ...
        ltcg_mtr1, ltcg_mtr2 = GrowModel._mtr12(calc1, calc2,
                                               mtr_of='p23250',
                                               tax_type='iitax')
    ...
    if not zero_sub_and_inc:
        if calc2_behv.behavior('BE_subinc_wrt_earnings'):
            calc2_behv = GrowModel._update_earnings(si_chg,
                                                   calc2_behv)
        else:
            calc2_behv = GrowModel._update_ordinary_income(si_chg,
                                                          calc2_behv)
    calc2_behv = GrowModel._update_cap_gain_income(ltcg_chg,
                                                  calc2_behv)
