...
2020-08-21 Release 3.0.0
------------------------
(last merged pull request is
[#TK](https://github.com/PSLmodels/Tax-Calculator/pull/TK))
...
- Remove the changes.md file to consolidate version reporting in this file, releases.md. [[#TK](https://github.com/PSLmodels/Tax-Calculator/pull/TK) by Matt Jensen] 
...
- The Tax-Calculator baseline was updated for the CBO's July 2 report, "An Update to the Economic Outlook: 2020-2030." [[#2462](https://github.com/PSLmodels/Tax-Calculator/pull/2462) by Peter Metz, with primary work in [TaxData PR #3332[(https://github.com/PSLmodels/taxdata/pull/314)] by Jacob Chuslo]


**Bug Fixes**
- Adjustments to the CPI_offset set under current law previously  overwrite the scheduled expiration of TCJA tax cut for parameters that are inflation indexed. The adoption of the new parameter_indexing_CPI_offset fixes this bug. We are unware of any users encountering this issues. [[#2413](https://github.com/PSLmodels/Tax-Calculator/pull/2413) by Peter Metz]
