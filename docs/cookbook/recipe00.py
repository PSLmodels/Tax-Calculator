...
#       where this program is located, then you can substitute the following
...
#       so we can continue to use pol and recs in this program without any
...
# specify Policy object using reform dictionary read from JSON reform file
