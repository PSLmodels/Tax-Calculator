TAX-CALCULATOR RELEASE HISTORY SINCE APRIL 2016
===============================================
...
- Add column to differences table to show the change in tax liability
  as percentage of pre-reform after tax income [#1375 by Anderson
  Frailey]
- Add policy reform file for the Renacci reform [#1376 and #1383 by
  Hank Doupe]

**Bug Fixes**
- Fix bug in add_weighted_income_bins utility function [#1387 by
  Martin Holmer]
